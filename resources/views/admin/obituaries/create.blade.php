            ...
            <div class="space-y-4 pt-2">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="date_of_death" value="{{ old('date_of_death') }}" placeholder="e.g. 2026 or 28/07/2026" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-300 rounded-xl text-sm">
