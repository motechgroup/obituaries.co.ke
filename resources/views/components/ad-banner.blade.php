@if($ad)
    <div class="my-6 text-center max-w-full overflow-hidden group">
        <div class="inline-block relative">
            ...
            @else
                <div class="block">
                    <img src="{{ $ad->banner_url }}" alt="{{ $ad->name }}" class="max-w-full h-auto rounded-2xl shadow-lg border border-slate-200 dark:border-slate-800 transition-all mx-auto">
                </div>
            @endif
        </div>
    </div>
