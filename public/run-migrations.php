<?php
/**
 * Web Database Migration Helper for Obituaries.co.ke
 * Access via browser: https://obituaries.co.ke/run-migrations.php
 */
...
<head>
    ...
    <title>Database Migrations | Obituaries.co.ke</title>
    <style>
        ...
        .badge { background: rgba(245, 158, 11, 0.15); color: #fbbf24; border: 1px solid rgba(245, 158, 11, 0.3); font-size: 11px; font-weight: 700; padding: 4px 10px; border-radius: 9999px; text-transform: uppercase; letter-spacing: 1px; }
...
<div class='container'>
    <div style='display:flex; justify-content:space-between; align-items:center; margin-bottom: 20px;'>
        <h1>⚡ Online Database Migrations</h1>
...
try {
    ...
    echo "<h3 style='color: #cbd5e1; margin-bottom: 8px;'>Migration Terminal Output:</h3>";
    echo "<pre>" . htmlspecialchars($migrateOutput ?: "Nothing to migrate. Database schema is already up to date.") . "</pre>";
    ...
    echo "<div class='alert-error'>
            ❌ Migration Error Occurred! Please check your database connection credentials in <code>.env</code> file.
          </div>";
    echo "<h3 style='color: #cbd5e1; margin-bottom: 8px;'>Exception Message:</h3>";
    echo "<pre style='color: #f87171; background: #450a0a; border-color: #7f1d1d;'>" . htmlspecialchars($e->getMessage()) . "</pre>";
}
